...
public class Geofence extends JavaScriptObject {
    ...
    public final native List<Coordinate> getCoordinates() /*-{
        return this.coordinates;
    }-*/;

    public final native void setCoordinates(List<Coordinate> coordinates) /*-{
    ...
    public final native void setUserId(int userId) /*-{
        this.userId = userId;
    }-*/;
