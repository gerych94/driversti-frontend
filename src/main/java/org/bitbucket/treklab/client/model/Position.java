...
public class Position extends JavaScriptObject {
    ...
    public final native int getDeviceId() /*-{
        return this.deviceId;
    }-*/;

    public final native void setDeviceId(int id) /*-{
    ...
    public final native void setAttributes(Attributes attributes) /*-{
    ...
    public final native String getServerTime() /*-{
        return this.serverTime
    }-*/;

    public final native void setServerTime(String serverTime) /*-{
        this.serverTime = serverTime;
    }-*/;

    public final native String getDeviceTime() /*-{
        return this.deviceTime
    }-*/;

    public final native void setDeviceTime(String deviceTime) /*-{
        this.deviceTime = deviceTime;
    }-*/;

    public final native String getFixTime() /*-{
        return this.fixTime;
    }-*/;

    public final native void setFixTime(String fixTime) /*-{
        this.fixTime = fixTime;
    }-*/;

    public final native boolean getOutdated()/*-{
        return this.outdated;
    }-*/;

    public final native void setOutdated(boolean outdated)/*-{
    ...
    public final native double getCourse()/*-{
        return this.course;
    }-*/;

    public final native void setCourse(double course)/*-{
        this.course = course;
    }-*/;
