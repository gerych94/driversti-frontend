...
public class Attributes extends JavaScriptObject {
    ...
    public final native int getSat() /*-{
        return this.sat;
    }-*/;

    public final native void setSat(int sat) /*-{
        this.sat = sat;
    }-*/;
    ...
    public final native void setEvent(int event) /*-{
        this.event = event;
    }-*/;
    ...
    public final native void setIp(String ip) /*-{
        this.ip = ip;
    }-*/;
    ...
    public final native void setBattery(double battery) /*-{
